...
class _HabilidadesState extends State<Habilidades> {
  ...
  Widget build(BuildContext context) {
    ...
    final viewportFraction = isDesktop ? 0.2 : 0.6; // Ajuste para telas menores
    final itemMargin = isDesktop ? 10.0 : 5.0; // Margens menores para telas menores
    final carouselHeight = isDesktop ? 300.0 : 250.0; // Ajuste de altura
